                    ...
                    <div class="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
                        <div class="mx-auto mb-12 text-center lg:mb-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor" class="mx-auto mb-6 h-8 w-8 text-green-700 dark:text-primary-400">
                        ...
                        <div class="mx-auto mb-12 text-center lg:mb-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor" class="mx-auto mb-6 h-8 w-8 text-red-600 dark:text-primary-400">
                        ...
                        <div class="mx-auto mb-6 text-center md:mb-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor" class="mx-auto mb-6 h-8 w-8 text-blue-600 dark:text-primary-400">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="mx-auto text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="fill" width="30" height="30" viewBox="0 0 84 64" stroke-width="2"
                                stroke="currentColor" class="mx-auto mb-6 h-8 w-8 text-yellow-600 dark:text-primary-400">
                                        ...
                                        <form>
                                            <div class="relative mb-6" data-te-input-wrapper-init>
                                                <input
                                                    ...
                                                    placeholder="Name" />
                                                <label
                                                    class="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-900 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:peer-focus:text-primary"
                                                    for="exampleInput90"
                                                >Name
                                                </label>
                                            </div>
