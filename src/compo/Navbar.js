        ...
        <div className={` h-24  mx-auto px-4 text-black z-50 fixed top-0 left-0 right-0  ${scrolled ? 'bg-white opacity-95' : ''}`}>
            <div className='h-24 max-w-[1240px] mx-auto flex justify-between items-center   px-4 text-black z-50 fixed top-0 left-0 right-0  '>
                ...
                <ul className={nav ? 'opacity-100 fixed left-0 top-0 w-[100%] h-full border-r border-r-gray-900 bg-lime-200 ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
                    ...
                    <li className='p-4 border-b border-gray-600'><a href='/Support' onClick={handleScrollToTop}>Support</a></li>
                    <li className='p-4 border-b border-gray-600'><a href='/Contactus' onClick={handleScrollToTop}>Contactus</a></li>
                    <li className='p-4 border-b border-gray-600'><a href='/Contact' onClick={handleScrollToTop}>Careers</a></li>
                </ul>
            </div>
        </div>
    );
